...
impl BaseTySONItemInterface for GtOperator {
    fn get_prefix(&self) -> String {
        GT_OPERATOR.to_string()
    }
}

impl TySONMap for GtOperator {
    ...
    fn insert(&mut self, k: Primitive, v: Item) -> Result<bool, DBError> {
        match v {
            ...
            _ => Err(DBError::TypeMismatch("gt operator can contain only primitives".to_string())),
        }
    }
    ...
    fn to_item(self) -> Item {
        Item::Map(MapItem::GtOperator(self))
    }
}
